        ...
        <div className="flex items-center justify-between relative">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative z-50" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-2 px-5 py-2 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition-all text-sm font-semibold text-gray-700 z-50 relative"
              >
              ...
              {isDropdownOpen && (
                <div className="absolute top-full left-0 mt-2 w-52 bg-gray-50 border border-gray-100 rounded-xl shadow-xl z-[100] overflow-hidden">
                  <button
                    ...
                    className={`w-full text-left px-5 py-3.5 text-sm font-semibold transition-all duration-200 relative group cursor-pointer ${
          ...
          <div className="flex items-center">
            <a
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-green-600 to-green-700 text-white px-5 py-2.5 rounded-lg font-semibold hover:from-green-700 hover:to-green-800 transition-all shadow-md hover:shadow-lg text-sm whitespace-nowrap"
            >
