      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 mb-6 md:mb-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-4 w-full">
              <img
                ...
                className="h-16 md:h-20 w-auto max-w-[280px] md:max-w-[320px] object-contain brightness-0 invert"
              />
            </div>
            <p className="text-gray-400 text-xs md:text-sm mb-4 text-center md:text-left">
              Onafhankelijk advies voor de beste energietarieven. Wij helpen je besparen op je energierekening.
            </p>
            <div className="flex gap-2 md:gap-3 justify-center md:justify-start w-full">
              <a
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="font-bold text-base md:text-lg mb-3 md:mb-4 text-white">Populaire Leveranciers</h3>
            <ul className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-3 md:gap-x-4 gap-y-2 text-gray-400">
              <li>
