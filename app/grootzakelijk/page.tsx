  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-green-600 via-green-700 to-green-800 text-white overflow-hidden">
        {/* Background Pattern - Farklı Çizgiler ve Desenler (Orijinal Koddan Korundu) */}
        <div className="absolute inset-0 opacity-30">
          {/* Bold Diagonal Lines - 60 degrees */}
          ...
          {/* Bold Diagonal Lines - 120 degrees (opposite direction) */}
          <div className="absolute inset-0" style={{
            backgroundImage: `repeating-linear-gradient(
              120deg,
              transparent,
          ...
          <div className="absolute top-1/4 right-1/4 w-[500px] h-[500px] bg-white/4 rounded-full blur-3xl"></div>
          <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-white/4 rounded-full blur-3xl"></div>
        </div>

        {/* İçerik - İkinci Koddaki Daha Kompakt Padding ve Gap Ayarları Kullanıldı */}
        <div className="container mx-auto px-4 py-8 md:py-16 lg:py-20 relative z-10">
          {/* Grid ayarları İkinci Koda göre güncellendi */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            <div className="text-left flex-shrink-0 md:pt-8">
              ...
              {/* Main Heading - Orijinal Metin Korundu, Boyutlandırma İkinci Koda Benzetildi */}
              ...
              {/* CTA Buttons - İkinci Koddaki Daha Kompakt Boyutlandırma Kullanıldı */}
              ...
              {/* Trust Indicators - İkinci Koddaki Boyutlandırma (text-xs, w-5 h-5) Kullanıldı */}
            ...
            <div className="flex justify-center md:justify-end w-full z-10 self-start relative md:sticky md:top-4">
              {/* Cashback Badge - İkinci Koddaki Daha Kompakt Boyutlandırma Kullanıldı */}
